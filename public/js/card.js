  document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
      ...
      productos.forEach(producto => {
        ...
        carta.innerHTML = `
          <div class="card-img">
            <img src="${producto.imagenprinc_tprd || 'https://via.placeholder.com/150'}" alt="${producto.nombre_tprd}" style="width: 100%; height: auto;">
          </div>
          <div class="card-info">
          ...
          <div class="card-footer">
            <span class="text-title">$${parseFloat(producto.precio_nprd).toLocaleString('es-CO', { minimumFractionDigits: 2 })}</span>
